...
import org.usfirst.frc.team1391.robot.TCPVisionMonitor;
	...
	public void sequence(){
    	...
    	if(active){
    		...
    		if(!rightAngle){
    			...
    			if(TCPVisionMonitor.getAngle() < 0){ //LEFT, needs to pull from vision
    			...
    			drivingForward = true;
    			if(TCPVisionMonitor.getIsTargetInFrame()){
    				if(TCPVisionMonitor.getAngle() < 5 && TCPVisionMonitor.getAngle() > 5){
    					centered = true;
    				}
    			}
